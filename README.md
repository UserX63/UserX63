...
if username.Text == "Nah" and password.Text == "I.Need.No.Pass" then
game:GetService('Players').LocalPlayer:Kick('HA BRO TOUGH HUH, Bro just login with normal.(U= member P= 2705)')
end
if username.Text == "support" and password.Text == " " then
print("llll")
end
